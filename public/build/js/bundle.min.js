function eventListeners(){const e=document.querySelector(".mobile-menu"),n=document.querySelector(".dark-mode-boton"),o=window.matchMedia("(prefers-color-scheme:dark)"),a=document.querySelectorAll('input[name="contacto[contacto]"]');console.log(a),a.forEach(e=>e.addEventListener("change",mostrarElemento)),o.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode"),o.addEventListener("change",(function(){o.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode")})),e.addEventListener("click",navegacionResponsive),n.addEventListener("click",darkmode)}function navegacionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}function darkmode(){document.body.classList.toggle("dark-mode")}function mostrarElemento(e){const n=document.querySelector("#contacto");"email"==e.target.value?n.innerHTML='\n        <hr>\n        <label for="email">E-mail</label>\n        <input type="email" placeholder="Tu email" id="email" name="contacto[email]" required>\n        ':n.innerHTML='\n        <hr>\n            <label for="telefono">Teléfono</label>\n            <input type="tel" placeholder="Tu teléfono" id="telefono" name="contacto[telefono]">\n            <p>Elija la fecha y hora para la llamada:</p>\n\n            <label for="fecha">Fecha</label>\n            <input type="date" id="fecha" name="contacto[fecha]">\n            <label for="hora">Hora</label>\n            <input type="time" id="hora" min="09:00" max="18:00" name="contacto[hora]">\n            '}
